...
//CNV-59719
* The following link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.20/html/virtualization/monitoring#virt-runbooks[alerts for the OpenShift Virtualization Operator] are now included in the {product-title} runbooks: 
